...
graph TD
    ...
    subgraph "MAIN MODULES"
        ...
        GW[gravitational_Waves<br/>GW's spectra - NEW]
...
| **gravitational_waves** | Abstract class that computes GW spectra and detectors curves!.       | Gives the gravitational waves spectra and the sensibility curves of LISA, DECIGO and BBO, which formulas comes from [arXiv:2002.04615](arXiv:2002.04615).                                        | [Module page](modules/gravitational_Waves/gravitational_Waves.md) |
